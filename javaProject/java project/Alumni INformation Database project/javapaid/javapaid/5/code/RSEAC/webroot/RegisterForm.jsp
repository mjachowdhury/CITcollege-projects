 ...
 <TABLE cellSpacing=0 cellPadding=0 width=775 align=center bgColor=#ffffff 
      ...
      document.write(TODAY);	</script></FONT></span><BR>
              ...
              <TR>
                ...
                <TD width=569 bgcolor="#D1C33C"><div align="right" class="style2"><jsp:include page="generaloptions.html"/> </div></TD>
                </TR>
              <TR>
			...
			<table width="761" height="334" border="0" align="right">
              <tr>
                ...
                <td width="462"><form action="RegisterAction.jsp" method="post" name="register">
                    ...
                    <tr>
                      <td><table width="481" border="0" align="center" bordercolor="#CD817E" bgcolor="#FAF9DE">
                        <tr>
                          ...
                          <td width="471"><div align="center"><span class="style11">R e g i s t r a t i o n</span></div></td>
                          <td width="10">&nbsp;</td>
                        </tr>
                        <tr>
                          <td align="right">&nbsp;</td>

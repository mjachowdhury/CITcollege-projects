 ...
 <TABLE cellSpacing=0 cellPadding=0 width=775 align=center bgColor=#ffffff 
      ...
      document.write(TODAY);	</script></FONT></span><BR>
              ...
              <TR>
                ...
                <TD width=569 bgcolor="#D1C33C"><div align="right" class="style2"><jsp:include page="generaloptions.html"/>
                 </div></TD>
                </TR>
              <TR>
              ...
              <TR>
                ...
                <tr>
				 ...
				 <jsp:include page="scroll.html"/> 
                  ...
                  <td width="412" valign="top"> <form action="AcadamicdetailsAction.jsp" method="post" name="register">

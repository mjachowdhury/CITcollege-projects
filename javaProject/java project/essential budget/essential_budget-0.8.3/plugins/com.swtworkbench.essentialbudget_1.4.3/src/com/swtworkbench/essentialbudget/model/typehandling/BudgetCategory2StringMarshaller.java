...
/**
 * Class BudgetCategory2StringMarshaller.  
 * 
 * @author daveo
 */
public class BudgetCategory2StringMarshaller implements IDataMarshaller {
    ...
    public Object convert(Object source) throws MarshallException {
        BudgetCategory budgetCategory = (BudgetCategory) source;

...
<center>
<h1> <font color="Green">Feedback Report</font></h1>
<form name="del" action="AttendeeMaster">
<%
   String prefix=request.getParameter("prefix");
%>
   <table>
   <tr><td><b>Select Event ID</td><td><select name="TEvtId1" onchange="javascript:var v=document.del.TEvtId1.value;location.href='Feedback_Report.jsp?id='+v+'&prefix=<%=prefix%>'">
...
<th bgcolor=green colSpan=30><font color="white">Feed back</font></th>

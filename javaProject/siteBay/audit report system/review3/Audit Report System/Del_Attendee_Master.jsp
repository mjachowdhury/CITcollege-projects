...
<center>
<h1> <font color="Green">Attendee Details</font></h1>
<form name="del" action="AttendeeMaster">
<%
   String prefix=request.getParameter("prefix");
%>
   <table>
   <tr><td><b>Select Meeting ID</td><td><select name="TMeetingId1" onchange="javascript:var v=document.del.TMeetingId1.value;location.href='Del_Attendee_Master.jsp?id='+v+'&prefix=<%=prefix%>'">

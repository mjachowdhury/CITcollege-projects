 ...
 public class EntryByCat extends JFrame implements ActionListener
 {
...
String[] col={"Book Category","Edition"};
 Container cont;
 public EntryByCat()
 {
 cont=getContentPane();
 ...
 cont.add(sp);
 l1=new JLabel("Book Category");
 l1.setBounds(20,40,100,30);
 l2=new JLabel("Edition");

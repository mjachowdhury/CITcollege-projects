...
import java.sql.*;
class songs extends JFrame implements ActionListener 
{
JButton b1,b2,b3;
JCheckBox c1,c2,c3;
JLabel l1,l2,l3;
...
songs()
{
setTitle("Search Songs   SEARCH RESULT");
setSize(600,600);
setLayout(null);
...
c1=new JCheckBox("Audio");
c1.setBounds(100,70,350,25);
c2=new JCheckBox("Video");
...
String query= "select * from Songs where S_name= '" +s1+ "'";

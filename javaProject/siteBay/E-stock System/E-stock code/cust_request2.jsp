...
else if(document.frm_buy.company.value=="")
{
alert("Please type the name of the company");
document.frm_buy.company.focus();
}
...
document.frm_buy.action="preview_buy.jsp";
document.frm_buy.submit();
document.frm_buy.method="post";
}
</script>
</head>
...
color="#008000"><b><font size="2">BUY         SHARES</font></b></font></div>
</td>
</tr>
</table>

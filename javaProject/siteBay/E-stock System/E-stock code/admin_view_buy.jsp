...
stmt=conn.prepareStatement("SELECT * FROM Buyer WHERE cid=? and COMPANY_NAME = ?  ");
stmt.setString(1,user_id);
rs=stmt.executeQuery();
%> 
<iframe name="I1" width="717" height="135" target="f2" scrolling="no" border="0" frameborder="0" src="admin_sellbuy.htm">

...
<body bgcolor="#FFFFFF">
<% 
String user_id=request.getParameter("cust_id");
...
%> 
<iframe name="I1" width="1000" height="150" target="f2" scrolling="no" border="0" frameborder="0" src="admin_sellbuy.htm">
...
<form name="f">
  <div align="center">
	  ...
	  <input type="button" name="b3" value="Back" onclick="history.back()" style="color: #800080; font-style: italic; font-weight: bold; border-style: outset; border-width: 3">

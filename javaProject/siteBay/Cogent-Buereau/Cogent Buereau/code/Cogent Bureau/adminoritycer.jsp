...
<center>
<font size=4 >
<u>Denay Minority Certificate Information</u> 
</font>    
<form method="get" name="pform" action="adviewminaction.do" onSubmit="return validateAll();" target="main">
  ...
  <%   try
   {
	  ...
	  String sqlSTMT="select mid,flag from MINORITYCERTIFICATE where flag=0";

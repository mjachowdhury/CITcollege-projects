...
<center>
<font size=4 >
<u>Administrator Apporved/Deny Information</u>
</font>
<form method="get" name="pform" action="dcandidateDetails.do" onSubmit="return validateAll();" target="main">
  ...
  <%   try
   {
	  ...
	  String sqlSTMT="select bcid,pflag from passportcertificate where pflag!=0 and flag=0";

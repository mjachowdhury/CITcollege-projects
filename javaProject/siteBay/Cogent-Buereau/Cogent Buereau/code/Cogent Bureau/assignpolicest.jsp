...
<form method="get" name="pform" action="candidateDetails.do" onSubmit="return validateAll();" target="main">
  ...
  <%   try
   {
	  ...
	  String sqlSTMT="select BCID,firstname,lastname from passportcertificate where pk is null";

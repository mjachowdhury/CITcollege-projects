...
public class DecideAdminAction extends Action
{

    public DecideAdminAction()
    {
    }
        ...
        throws Exception
    {
        ...
        PreparedStatement stmt = con.prepareStatement("update passportcertificate set flag=? where bcid=?");

...
%>
 <%
 org.district.DeathCer  br=(org.district.DeathCer)request.getAttribute("deathcer");
 %>
...
<tr>
  ...
  <td><font size=4><%=br.getHospital()%></font></td>
    ...
    <br><br>
	<input type="hidden" name="dcid" value='<%=((org.district.DeathCer)request.getAttribute("deathcer")).getDcid()%>'/>
  <tr>

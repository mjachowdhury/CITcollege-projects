...
%>
 <%
 org.district.Domicile br=(org.district.Domicile)request.getAttribute("resdcer");
 %>
<body background="<%=path%>/images/shade1.gif">
 <form method="get" name="aform" action="decideDomcile.do" target="main">
 <center>  
...
<tr>
  ...
  <td><font size=4><%=br.getDor()%></font></td>
      ...
      <br><br>
	<input type="hidden" name="did" value='<%=((org.district.Domicile)request.getAttribute("resdcer")).getDcid()%>'/>
  <tr>

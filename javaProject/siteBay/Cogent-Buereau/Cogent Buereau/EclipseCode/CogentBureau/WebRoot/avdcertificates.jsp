...
<center>
<font size=4 >
<u>Denayed Certificate Informationn</u>
</font>
<form method="get" name="pform" action="adcandidateDetails.do" onSubmit="return validateAll();" target="main">
  ...
  <%   try
   {
	  ...
	  String sqlSTMT="select bcid,flag from passportcertificate where flag=0";

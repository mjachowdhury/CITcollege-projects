...
%>
 <%
 org.district.MinorityCer br=(org.district.MinorityCer)request.getAttribute("mincer");
 %>
<body background="<%=path%>/images/shade1.gif">
<form name="aform" method="get" action="decideMinoity.do"> 
 <center>
...
<tr>
  ...
  <td><font size=4><%=br.getDor()%></font></td>
    ...
    <br><br>
	<input type="hidden" name="mid" value='<%=((org.district.MinorityCer)request.getAttribute("mincer")).getMcid()%>'/>
  <tr>

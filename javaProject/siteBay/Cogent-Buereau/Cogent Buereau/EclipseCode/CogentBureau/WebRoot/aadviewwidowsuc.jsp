...
%>
 <%
 org.district.WidowCer br=(org.district.WidowCer)request.getAttribute("widowcer");
 %>
...
<tr>
  ...
  <td><font size=4><%=br.getHospital()%></font></td>
    ...
    <br><br>
	<input type="hidden" name="wcid" value='<%=((org.district.WidowCer)request.getAttribute("widowcer")).getWcid()%>'/>
  <tr>

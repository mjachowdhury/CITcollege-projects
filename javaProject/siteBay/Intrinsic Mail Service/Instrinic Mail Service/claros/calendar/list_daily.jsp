			        ...
			        <td><table width="99%" height="20" border="0" cellpadding="3" cellspacing="3" align="left">
			          <tr>
			            <td nowrap width="99%">
			            	...
			            	<span class="tableheadertext youarehere">CALENDAR - DAILY :</span> (<fmt:formatDate value="${dateDisplayed}" pattern="dd MMM yyyy, EEEEE"/>)
			            </td>
			      ...
			      <tr>
			        <td>&nbsp;</td>
					  ...
					  <table width="99%" border="0" align="center" cellpadding="0" cellspacing="1" class="tablesm">
	                          ...
	                          <tr>
	                            <td width="33%" bgcolor="#397BBE">
	                            	<table width="100%" border="0" cellspasing="1" cellpadding="0">
	                            		<tr>
	                            			<td align="left">
	                            				<html-el:link page="/listDaily.do?t=${prevTime}" title="Previous Day"><span class="texttahoma12whitebold">&lt;</span></html-el:link>
	                            			</td>
	                            			<td align="center">
	                            				<div align="center" class="texttahoma12whitebold">Daily Program </div>
	                            			</td>
	                            			<td align="right">
	                            				<html-el:link page="/listDaily.do?t=${nextTime}" title="Next Day"><span class="texttahoma12whitebold">&gt;</span></html-el:link>
	                            			</td>
	                            		</tr>
	                            	</table>
	                            </td>
	                            <td width="33%"><div align="center"><html:link page="/listWeekly.do" styleClass="texttahoma12black">Weekly Program</html:link></div></td>
	                            <td bgcolor="#DFE4E8"><div align="center"><html:link page="/listMonthly.do" styleClass="texttahoma12black">Monthly Program</html:link></div></td>
	                          </tr>
	                      </table></td>
	                    </tr>
	                    <tr>
						...
						<c:forEach items="${dailyContent.hours}" var="item" varStatus="stat">
		                    <tr>
							  <c:choose>
								...
								<table width="98%"  border="0" align="center" cellpadding="0" cellspacing="0">
		                          <tr>
		                            <td width="35" class="texttahoma11" align="right"><span class="texttahoma12black"><c:out value="${item.hour}"/>:00</span></span></td>
		                            <td width="20">&nbsp;</td>
		                            <td colspan="2">

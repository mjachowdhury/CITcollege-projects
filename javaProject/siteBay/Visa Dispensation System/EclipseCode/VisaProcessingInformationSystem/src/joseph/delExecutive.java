...
public class delExecutive extends HttpServlet
{
        ...
        throws ServletException, IOException
    {
        ...
        try
        {
            ...
            String s2 = (new StringBuilder()).append("delete from executive where ExeID='").append(s).append("'").toString();
        ...
        httpservletresponse.sendRedirect("Admin/DeleteExecutive.jsp");
    }

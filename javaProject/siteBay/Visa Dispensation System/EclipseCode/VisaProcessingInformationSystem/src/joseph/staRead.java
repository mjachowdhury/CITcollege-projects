...
public class staRead extends HttpServlet
{
        ...
        throws ServletException, IOException
    {
        ...
        try
        {
            String s1 = (new StringBuilder()).append("Update Renewal set Status='Unread' where RenID='").append(s).append("'").toString();
        ...
        httpservletresponse.sendRedirect("Admin/urVisaRenewal.jsp");
    }

...
<table width="900" height="100%" align="center">
		...
		<table width="100%" height="100%" border="0">
			<tr>
				...
				<td width="*" height="100%" valign="top"><br><br>
					...
					<form name="f1" action="../Interview"  method="post" >
						<tr>
                  <td width="200"><font color="#001967"><strong>Interview Details</strong></font></td>
                  <td width="*"></td></tr>
  ...
  <td width="200" align="right"><font color="#001967">Interview Date 
                  :</font> </td>
                <td align="left">
...
<td width="200" align="right"><font color="#001967">Interview Time
                  :</font> </td>
                <td align="left">
...
<tr>
                <td width="200" align="right"><font color="#001967">Venue :</font> 
                </td>
                <td align="left"><input name="Venue" type="text" id="Venue" maxlength="30"></td></tr>

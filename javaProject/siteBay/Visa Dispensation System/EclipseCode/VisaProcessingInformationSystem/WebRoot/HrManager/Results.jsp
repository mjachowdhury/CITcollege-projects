		...
		<table width="100%" height="100%" border="0">
			<tr>
				...
				<td width="*" height="100%" valign="top"><br><br>
					...
					<form name="f1" action="ShowResults.jsp" method="post" onSubmit="return Validate();">
						<tr>
	...
	<td>
		<select name="EmpID">
			...
			<% 
				...
				ResultSet rs=con.getResultSet("select EmpID,EmpName from EmpDetails where EmpID in (select distinct(EmpID) from ApplicationEntry where Enquiry='yes' and Interview='yes' and Results='no')");
				while(rs.next()){

		...
		<table width="100%" height="100%" border="0">
			<tr>
				...
				<td width="*" height="100%" valign="top"><br><br>
					...
					<form name="f1" action="../Results"  method="post" >
						<tr>
                  <td width="200"><font color="#001967"><strong>Results Details</strong></font></td>
                  <td width="*"></td></tr>
...
<td align="right"><font color="#001967">Resullt</font><td><font color="#0000FF">:&nbsp;<textarea name=res></textarea><font color="#001967"></td>
				</td></tr>

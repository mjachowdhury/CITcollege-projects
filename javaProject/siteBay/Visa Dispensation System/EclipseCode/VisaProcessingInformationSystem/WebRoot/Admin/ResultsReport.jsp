			...
			<tr>
				...
				<jsp:include page="menu.jsp" flush="true" />
					...
					<table width="100%" border="0">
						<tr><td width="200" align="left"><font color="#001967"><strong>Results Status Report</strong></font></td>
...
<tr class=row_title>
	<th class=row_title><FONT COLOR="#FF0000">Employ IDs/Results Status</FONT></th>
		<%
			for(iCount=0;iCount<VCount;iCount++){

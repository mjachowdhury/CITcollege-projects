...
<body Class=SC>
<FORM METHOD=POST ACTION="" NAME="VPlotsForm">
<center>
...
<h3 align=center> Vacant Plots </h3>
<BR><BR>
...
try
{
	...
	String Qry = "Select * from PlotDetails where Status = 'Vacant' order by PlotNo";
